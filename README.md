...
| **⚙️ Modul Konfigurasi Aplikasi**          | Pengaturan hak akses granular: **Master Akses Level**, **Master Akses Grup** (Roles & Permissions with rich HTML tooltip), dan **Master Menu** (Dynamic Navigation Management).                                                  |
| **🏛️ 14 Modul Master Data**               | Tata kelola CRUD lengkap: _Regional, UIW/UID, UIK, UP2D, UPK, Unit Layanan, Sentral Pembangkit, User (20-field), Permission, Driver, Organisasi, Sistem, Aset Mesin, dan Kondisi Mesin_.                                        |
