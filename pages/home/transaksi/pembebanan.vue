    ...
    <div class="flex-1 flex flex-col p-4 sm:p-6 min-h-0 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <BaseCreateButton resource="PEMBEBANAN" @click="openCreateModal" />
        </div>
        ...
        >
          ...
          <template #actions-data="{ row }">
            <div class="flex items-center gap-1.5">
              ...
              <BaseActionButton type="edit" resource="PEMBEBANAN" @click="handleEdit(row)" />
              <BaseActionButton type="delete" resource="PEMBEBANAN" @click="handleDelete(row)" />
            </div>
          </template>
        </BaseTable>
